...
(function($) {
                    ...
                    item.addEventListener('mouseenter', e => {
                        ...
                        if (typeof TweenMax !== 'undefined' && typeof TweenMax !== null) {
                            if (item !== active_item) {
                                TweenMax.fromTo(
                                    displaceMentEl,
                                    1.2, { attr: { scale: 50 } }, { attr: { scale: 0.3 } }
                                );
                            }
                        }
    ...
    instagramWrapperItems.forEach(function(instagramWrapperItem) {
        ...
        $.ajax({
            url: 'https://graph.instagram.com/me/media?fields=id,media_type,media_url,timestamp,permalink&access_token=' +
                token,
            type: 'GET',
